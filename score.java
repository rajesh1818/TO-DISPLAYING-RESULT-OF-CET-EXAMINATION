...
public class score extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("GET CET SCORE");
        ...
        score.setBackground(java.awt.Color.darkGray);
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(rollno, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
    ...
    rs = f.find(rollno.getText());
    try{
      if(rs.next()){
         
                    score.setText(rs.getString("score"));
      }  else{
          JOptionPane.showMessageDialog(null, "NO DATA FOR THIS roll number");
      }
    }catch(Exception ex){
     ...
     public class Function{
       ...
       con = DriverManager.getConnection("jdbc:mysql://localhost/exam","root","root");
           ps = con.prepareStatement("select * from cet where rollno = ?");
           ps.setString(1,s);
           rs = ps.executeQuery();
           }catch(Exception ex){
              JOptionPane.showMessageDialog(null, ex.getMessage());
